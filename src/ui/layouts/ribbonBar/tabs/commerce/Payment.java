...
public class Payment {
    ...
    private void buildVisaButton() {
        ...
        //Add image.
        String imgPath = "/ui/common/images/Dollar.png";
        ...
        this.btnV.getStyleClass().add("leftToggleButton");       //Set Tooltip
        ...
        this.btnV.setOnAction(new EventHandler() {
            ...
            public void handle(Event event) {
                System.out.println("Visale Button clicked.");
    ...
    private void buildMasterCardButton() {
        ...
        this.btnMC.getStyleClass().add("middleToggleButton");        //Set Tooltip
        ...
        this.btnMC.setOnAction(new EventHandler() {
            ...
            @Override
            public void handle(Event event) {
                System.out.println("MasterCardle Button clicked.");
    ...
    private void buildAmericanExpressButton() {
        ...
        this.btnA.getStyleClass().add("middleToggleButton");        //Set Tooltip
        ...
        this.btnA.setOnAction(new EventHandler() {
            ...
            @Override
            public void handle(Event event) {
                System.out.println("Americaness Toggle Button clicked.");
    ...
    private void buildDiscoverButton() {
        ...
        this.btnD.getStyleClass().add("middleToggleButton");        //Set Tooltip
        ...
        this.btnD.setOnAction(new EventHandler() {
            ...
            @Override
            public void handle(Event event) {
                System.out.println("Discover Toggle Button clicked.");
	...
	private void buildPayPalButton() {
		...
		// Add image.
		String imgPath = "/ui/common/images/Help.png";
		Image image = new Image(this.getClass().getResourceAsStream(imgPath), 24.0, 24.0, true, true);
		ImageView imageView = new ImageView(image);
		this.btnP.setGraphic(imageView);

		// Set CSS Styles.
		this.btnP.getStyleClass().add("ribbonToggleButton");
		this.btnP.getStyleClass().add("rightToggleButton"); // Set Tooltip
		...
		this.btnP.setOnAction(new EventHandler() {
			...
			@Override
			public void handle(Event event) {
				System.out.println("PayPalle Button clicked.");
