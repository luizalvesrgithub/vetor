...
public class ColorfulIcons {
	...
	private void buildGiftWrapButton() {
		...
		String imgPath = "/ui/common/images/Alarm.png";
	...
	private void buildNotesButton() {
		...
		String imgPath = "/ui/common/images/Notes.png";
		Image image = new Image(this.getClass().getResourceAsStream(imgPath), 24.0, 24.0, true, true);
		ImageView imageView = new ImageView(image);
		...
		this.btnNotes.setOnAction(new EventHandler() {
			...
			@Override
			public void handle(Event event) {
				System.out.println("Noteson clicked.");
	...
	private void buildCustomerDetailsButton() {
		...
		String imgPath = "/ui/common/images/Company.png";
		Image image = new Image(this.getClass().getResourceAsStream(imgPath), 24.0, 24.0, true, true);
		ImageView imageView = new ImageView(image);
		...
		this.btnContactDetails.setOnAction(new EventHandler() {
			...
			@Override
			public void handle(Event event) {
				System.out.println("Customerils Button clicked.");
	...
	private void buildMagicWandButton() {
		...
		String imgPath = "/ui/common/images/Danger.png";
		Image image = new Image(this.getClass().getResourceAsStream(imgPath), 24.0, 24.0, true, true);
		ImageView imageView = new ImageView(image);
