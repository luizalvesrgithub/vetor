...
public class Clipboard {
    ...
    private void buildPasteButton() {
        ...
        String imgPath = "/ui/common/images/Clipboard.png"; //"/com/resc/br/clipboard.png";
        ...
        mnuPasteSpecial.setOnAction(new EventHandler() {
            ...
            @Override
            public void handle(Event event) {
                System.out.println("Pasteial clicked.");
            }
        ...
        mnuPasteHyperlink.setOnAction(new EventHandler() {
            ...
            @Override
            public void handle(Event event) {
                System.out.println("Pasteyperlink clicked.");
            }
    ...
    private void buildCutButton() {
        ...
        String imgPath = "/ui/common/images/Cut.png"; //"/com/resc/br/cut.png";
        ...
        this.cutButton.setOnAction(new EventHandler() {
            @Override
            public void handle(Event event) {
                System.out.println("Cuton Clicked.");
            }
        });
    }
    ...
    private void buildCopyButton() {
        ...
        this.copyButton.setOnAction(new EventHandler() {
            @Override
            public void handle(Event event) {
                System.out.println("Copyon Clicked.");
            }
        });
    }
