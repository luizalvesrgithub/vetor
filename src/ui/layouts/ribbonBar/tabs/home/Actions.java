...
public class Actions {
	...
	private void buildNewButton() {
		...
		this.btnNew.setOnAction(new EventHandler() {
			...
			public void handle(Event event) {
				System.out.println("Newr Button clicked.");
	...
	private void buildOpenButton() {
		...
		// Add image.
		String imgPath = "/ui/common/images/openfile.jpg";
		Image image = new Image(this.getClass().getResourceAsStream(imgPath), 24.0, 24.0, true, true);
		ImageView imageView = new ImageView(image);
		...
		this.btnOpen.setOnAction(new EventHandler() {
			...
			@Override
			public void handle(Event event) {
				System.out.println("Opent Order Button clicked.");
	...
	private void buildEmailButton() {
		...
		// Add image.
		String imgPath = "/ui/common/images/E-mail.png";
		Image image = new Image(this.getClass().getResourceAsStream(imgPath), 24.0, 24.0, true, true);
		ImageView imageView = new ImageView(image);
		...
		this.btnEmail.setOnAction(new EventHandler() {
			...
			@Override
			public void handle(Event event) {
				System.out.println("Emailr Button clicked.");
	...
	private void buildPrintButton() {
		...
		this.btnPrint.setOnAction(new EventHandler() {
			...
			@Override
			public void handle(Event event) {
				System.out.println("Printice Button clicked.");
	...
	private void buildDeleteButton() {
		...
		this.btnDelete.setOnAction(new EventHandler() {
			...
			@Override
			public void handle(Event event) {
				System.out.println("Deleter Button clicked.");
	...
	private void buildPDFButton() {
		...
		// Add image.
		String imgPath = "/ui/common/images/Play.png";
		Image image = new Image(this.getClass().getResourceAsStream(imgPath), 24.0, 24.0, true, true);
		ImageView imageView = new ImageView(image);
		...
		this.btnPDF.setOnAction(new EventHandler() {
			...
			@Override
			public void handle(Event event) {
				System.out.println("PDFrt Button clicked.");
