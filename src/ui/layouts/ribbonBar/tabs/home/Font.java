...
public class Font {
    ...
    private void buildFontFamilyChoiceBox() {
        ...
        this.cbxFontFamily.setId("fontFamilyChoiceBox");        //Proceed with caution here. The ChangeListener is new to me.
        this.cbxFontFamily.getSelectionModel().selectedIndexProperty()
            ...
            Object prevValue, Object nextValue) {
                ...
                System.out.printf("Theinal font selection was: %s\n", 
                        oldFont);
                System.out.printf("Theent font selection is: %s\n", 
                        newFont);
            }
    ...
    private void buildFontSizeChoiceBox() {
        ...
        //Set CSS ID
        this.cbxFontSize.setId("fontSizeChoiceBox");        //Proceed with caution here. The ChangeListener is new to me.
        this.cbxFontSize.getSelectionModel().selectedIndexProperty()
            ...
            Object prevValue, Object nextValue) {
                ...
                System.out.printf("Theinal font size was: %s\n", 
                        oldFont);
                System.out.printf("Theent font size is: %s\n", 
                        newFont);
            }
    ...
    private void buildBoldButton() {
        String imgPath = "/ui/common/images/Bomb.png";
        ...
        this.btnBold.setOnAction(new EventHandler() {
            ...
            public void handle(Event event) {
                if (btnBold.isSelected())
                    System.out.println("Bolde Selected.");
                else
                    System.out.println("Bolde Deselected.");
    ...
    private void buildItalicsButton() {
        String imgPath = "/ui/common/images/In-yang.png"; //italics.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
        ...
        this.btnItalics.setOnAction(new EventHandler() {
            ...
            public void handle(Event event) {
                if (btnItalics.isSelected())
                    System.out.println("Italicse Selected.");
                else
                    System.out.println("Italicse Deselected.");
            }
    ...
    private void buildUnderlineButton() {
        String imgPath = "/ui/common/images/Twitter.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
        ...
        this.btnUnderline.setOnAction(new EventHandler() {
            ...
            public void handle(Event event) {
                if (btnUnderline.isSelected())
                    System.out.println("Underlinee Selected.");
                else
                    System.out.println("Underlinee Deselected.");
            }
    ...
    private void buildSuperScriptButton() {
        ...
        String imgPath = "/ui/common/images/Wallet.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
        ...
        this.btnSuper.setOnAction(new EventHandler() {
            ...
            public void handle(Event event) {
                if (btnSuper.isSelected())
                    System.out.println("SuperScripte Selected.");
                else
                    System.out.println("SuperScripte Deselected.");
            }
        ...
        this.btnSub.setOnAction(new EventHandler() {
            ...
            public void handle(Event event) {
                if (btnSub.isSelected())
                    System.out.println("SubScripte Selected.");
                else
                    System.out.println("SubScripte Deselected.");
            }
    ...
    private void buildEraserButton() {
        String imgPath = "/ui/common/images/Erase.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
        ...
        this.btnEraser.setOnAction(new EventHandler() {
            ...
            @Override
            public void handle(Event event) {
                System.out.println("Clear Styles Button Selected.");
            }
    ...
    private void buildIncreaseFontSizeButton() {
        String imgPath = "/ui/common/images/Iphone.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
        ...
        this.btnIncreaseFontSize.setOnAction(new EventHandler() {
            ...
            @Override
            public void handle(Event event) {
                System.out.println("Increase Size Button Selected.");
            }
    ...
    private void buildDecreaseFontSizeButton() {
        String imgPath = "/ui/common/images/Last.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
        ...
        this.btnDecreaseFontSize.setOnAction(new EventHandler() {
            ...
            @Override
            public void handle(Event event) {
                System.out.println("Decrease Size Button Selected.");
            }
