...
public class Driver extends Application {
    ...
    public void start(Stage stage) {
        ...
        layout.setId("app");        //Set BorderPane Regions AQUIIII
    ...
    private void setSceneProperties()
    {
        ...
        String css = this.getClass().getResource("App.css").toExternalForm();  //Add CSS for Tabs.
        String tabsURL = "/css/tabs.css";
