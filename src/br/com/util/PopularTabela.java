...
public class PopularTabela extends JFrame 
{
  protected JTable m_table;
  protected StockTableData m_data;
  protected JLabel m_title;

  public PopularTabela(Connection con, String tabela, Vector<String> titulosColunas) {
    super("Stocks Table");
    setSize(600, 300);
  ...
  public static void main(String argv[]) {
    new PopularTabela(null, null, null);
  }
}
